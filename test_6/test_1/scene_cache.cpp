...
AppSceneCache::AppSceneCache()
{
}

std::shared_ptr<ModelData> AppSceneCache::get_model_data(const std::string &name)
{
	if (name == "plane")
		return create_plane();
	else if (name == "box")
...
Resource<Texture> AppSceneCache::get_texture(GraphicContext &gc, const std::string &name, bool linear)
{
...
void AppSceneCache::update_textures(GraphicContext &gc, float time_elapsed)
{
	// Update animated textures here.
}

std::shared_ptr<ModelData> AppSceneCache::create_plane()
{
	...
	model_data->textures[0].name = "../Resources/med.png";
	//model_data->textures[0].name = "../Resources/tux.png";
...
std::shared_ptr<ModelData> AppSceneCache::create_box()
{
	std::shared_ptr<ModelData> model_data(new ModelData());
	...
	model_data->textures.resize(1);
	model_data->textures[0].gamma = 2.2f;
	model_data->textures[0].name = "../Resources/wabbit.png";
	//model_data->textures[0].name = "../Resources/tux.png";
...
std::shared_ptr<ModelData> AppSceneCache::create_gate()
{
	std::shared_ptr<ModelData> model_data(new ModelData());
...
std::shared_ptr<ModelData> AppSceneCache::create_tower()
{
	std::shared_ptr<ModelData> model_data(new ModelData());
	...
	model_data->textures.resize(1);
	model_data->textures[0].gamma = 2.2f;
	model_data->textures[0].name = "../Resources/white-tower.png";
